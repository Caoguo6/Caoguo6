...
<head>
    <meta charset="UTF-8">
    <title>每日一学音乐解析————音乐解析网,免费音乐下载网,多站合一音乐搜索解析</title>
    ...
    <meta name="keywords" content="音乐搜索,音乐搜索器,音乐试听,音乐在线听,网易云音乐免费下载,QQ音乐免费下载,酷狗音乐免费下载,酷我音乐免费下载,虾米音乐免费下载,百度音乐免费下载,一听音乐免费下载,咪咕音乐免费下载,荔枝FM免费下载,蜻蜓FM免费下载,喜马拉雅FM免费下载,全民K歌免费下载,5sing原创翻唱音乐免费下载">
    <meta name="description" content="每日一学音乐解析————音乐解析网,免费音乐下载网,多站合一音乐搜索解析，可搜索试听下载网易云音乐、QQ音乐、酷狗音乐、酷我音乐、虾米音乐、百度音乐、一听音乐、咪咕音乐、荔枝FM、蜻蜓FM、喜马拉雅FM、全民K歌、5sing原创翻唱音乐。">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="apple-mobile-web-app-title" content="每日一学音乐搜索器">
    <meta name="application-name" content="每日一学音乐搜索器">
...
<body>
    ...
    <section class="am-g about">
        <div class="am-container am-margin-vertical-xl">
            <header class="am-padding-vertical">
                <h2 class="about-title about-color">每日一学音乐搜索器</h2>
                <p class="am-text-center">多站合一音乐搜索解析下载</p>
            </header>
            <hr>
                ...
                <form id="j-validator" class="am-form am-margin-bottom-lg" method="post">
                    <div class="am-u-md-12 am-u-sm-centered">
                        ...
                        <div class="am-form-group">
                            <input id="j-input" data-filter="name" class="am-form-field am-input-lg am-text-center am-radius" placeholder="例如:恋曲1990  罗大佑" data-am-loading="{loadingText: ' '}" pattern="^.+$" required>
                        ...
                        <button id="j-submit" type="submit" class="am-btn am-btn-primary am-btn-lg am-btn-block am-radius" data-am-loading="{spinner: 'cog', loadingText: '正在搜索相关音乐...', resetText: 'Get &#x221A;'}">摸它一下</button>
						<button id="tws" type="submit11" onClick="window.open('http://meiriyixue.cn/mryt.php')" style="background:#25cba3" class="am-btn am-btn-primary am-btn-lg am-btn-block am-radius" >听腻了？ 去看看优惠券</button>
                    </div>
                </form>
                <form id="j-main" class="am-form am-u-md-12 am-u-sm-centered music-main">
                    <a type="button" id="j-back" class="am-btn am-btn-success am-btn-lg am-btn-block am-radius am-margin-bottom-lg">摸成功 Get &#x221A; 返回继续 <i class="am-icon-reply am-icon-fw"></i></a>
    ...
    <footer class="footer">
        <p class="am-text-sm">v<?php echo MC_VERSION; ?>&nbsp;&copy;&nbsp;<?php echo date('Y'); ?>&nbsp;<a href="http://meiriyixue.cn" target="_blank" rel="author">每日一学网</a>&nbsp;<a href="http://www.meiriyixue.cn/150.html" target="_blank">意见反馈</a>&nbsp;<a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">免责声明</a></p>
    </footer>
...
<script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1272967242'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s13.cnzz.com/z_stat.php%3Fid%3D1272967242%26show%3Dpic' type='text/javascript'%3E%3C/script%3E"));</script>
</body>
</html>
